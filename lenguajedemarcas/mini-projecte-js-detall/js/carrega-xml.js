...
async function carregaJocs() {
    ...
    try {
        ...
        jocs.forEach((joc) => {
            ...
            // // 5. Cel·la amb l'enllaç a la pàgina de detall
            // const tdDetall = document.createElement("td");
            // const enllac = document.createElement("a");
            // // Passem l'ID per la URL: detall.html?id=G001, etc.
            // enllac.href = "detall.html?id=" + encodeURIComponent(id);
            // enllac.textContent = "Veure detall de " + titol;
            // tdDetall.appendChild(enllac);
            // tr.appendChild(tdDetall);
            // // 5. Cel·la amb l'enllaç a la pàgina de detall
