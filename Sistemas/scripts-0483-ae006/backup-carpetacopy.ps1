...
$leerOri = Read-Host "Introduce la carpeta que quiere hacer backup (desde $Home)"
$leerDes = Read-Host "Introduce el nombre de la carpeta donde quiere enviar el backup"


$Origen = Join-Path $HOME "$leerOri"
$Desti  = Join-Path $HOME "$leerDes"
